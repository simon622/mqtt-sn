...
Paho Mqtt C Embedded | Various | [GitHub Repository](https://github.com/eclipse/paho.mqtt.embedded-c) | Fully featured embedded MQTT C client library | :heavy_check_mark: | :x: | :heavy_check_mark: | :heavy_multiplication_x:
