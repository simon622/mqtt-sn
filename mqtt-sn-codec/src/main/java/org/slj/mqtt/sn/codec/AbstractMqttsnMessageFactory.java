...
public abstract class AbstractMqttsnMessageFactory implements IMqttsnMessageFactory  {
    ...
    @Override
    public IMqttsnMessage createProtectionMessage(byte protectionScheme, byte[] senderId, long nonce, int montonicCounter, long keyMaterial, byte[] encapsulatedMessage) throws MqttsnCodecException {
