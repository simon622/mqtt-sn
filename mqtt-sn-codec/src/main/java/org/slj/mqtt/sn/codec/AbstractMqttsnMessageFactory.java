...
public abstract class AbstractMqttsnMessageFactory implements IMqttsnMessageFactory  {
    ...
    @Override
    public IMqttsnMessage createProtectionMessage(IProtectionScheme protectionSchema, byte[] protectionKey, ProtectionPacketFlags flags, byte[] senderId, byte[] random, byte[] cryptoMaterial, int monotonicCounter, byte[] encapsulatedMessage) throws MqttsnCodecException {
    ...
    @Override
    public IMqttsnMessage createConnack(int returnCode, boolean sessionExists, String assignedClientId, long sessionExpiryInterval) throws MqttsnCodecException {
       throw new MqttsnCodecException("message not supported by codec");
    }
    ...
    @Override
    public IMqttsnMessage createDisconnect(long sessionExpiryInterval, boolean retainRegistrations) throws MqttsnCodecException {
       throw new MqttsnCodecException("message not supported by codec");
    }
