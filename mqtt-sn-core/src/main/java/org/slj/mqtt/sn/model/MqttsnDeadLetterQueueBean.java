...
public class MqttsnDeadLetterQueueBean implements Serializable {

    private static final long serialVersionUID = -6257398474406663412L;
    ...
    public String toString() {
        return message;
//        return "MqttsnDeadLetterQueueBean{" +
//                "context=" + context +
