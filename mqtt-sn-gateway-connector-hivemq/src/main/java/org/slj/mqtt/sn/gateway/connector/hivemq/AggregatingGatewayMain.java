...
import org.slj.mqtt.sn.gateway.connector.hivemq.HiveMQMqttsnBrokerConnectionFactory;
...
public class AggregatingGatewayMain {
    public static void main(String[] args) throws Exception {
        ...
        AbstractMqttsnRuntimeRegistry registry = MqttsnGatewayRuntimeRegistry.defaultConfiguration(gatewayOptions).
                withBrokerConnectionFactory(new HiveMQMqttsnBrokerConnectionFactory()).
