...
public class ConfigHandler extends MqttsnConsoleAjaxRealmHandler {
    ...
    protected PropertiesBean populateBean() throws MqttsnException {
        ...
        bean.add("Session Expiry Interval", options.getSessionExpiryInterval(), "");
        bean.add("Max. Awake Messages", options.getDefaultMaxAwakeMessages(), "");
        return bean;
    }
