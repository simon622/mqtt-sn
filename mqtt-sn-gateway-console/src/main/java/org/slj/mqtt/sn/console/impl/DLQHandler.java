...
public class DLQHandler extends MqttsnConsoleAjaxRealmHandler {

    public DLQHandler(ObjectMapper mapper, IMqttsnRuntimeRegistry registry) {
    ...
    protected DLQBean populateBean() throws MqttsnException {
        DLQBean bean = new DLQBean();
        List<MqttsnDeadLetterQueueBean> l = getRegistry().getDeadLetterQueue().readMostRecent(100);
        bean.list = l;
        return bean;
    }
    ...
    class DLQBean {
        ...
        public List<MqttsnDeadLetterQueueBean> list;
