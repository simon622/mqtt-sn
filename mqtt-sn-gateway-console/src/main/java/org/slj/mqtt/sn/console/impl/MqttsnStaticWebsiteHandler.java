...
public class MqttsnStaticWebsiteHandler extends StaticFileHandler {
    ...
    protected MqttsnConsoleOptions options;

    public MqttsnStaticWebsiteHandler(MqttsnConsoleOptions options, ObjectMapper mapper, IMqttsnRuntimeRegistry registry) {
        super(mapper, ROOT);
