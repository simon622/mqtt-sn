...
public abstract class AbstractExecutionProfile implements ExecutionProfile {
    ...
    protected abstract void executeInternal(ExecutionProgress progress);
